...
const statusBadgeStyles: Record<MockProject["status"], string> = {
  active:
...
function getStatusLabel(status: MockProject["status"]) {
  switch (status) {
    case "active":
      return "Активен";
    case "paused":
...
export default function ProjectsPage() {
  ...
  const pausedCount = mockProjects.filter((p) => p.status === "paused").length;
